                            ...
                            onPressed: () async {
                              ...
                              await repo.upsertStudent(
                                companion: StudentRecordsCompanion(
                                  ...
                                  manualResultReason: const Value(null),
                                  manualResultChangedAt: const Value(null),
                                  manualResultInstructorInitials: const Value(null),
    ...
    try {
      ...
      await services.studentRepository.upsertStudent(
        companion: StudentRecordsCompanion(
          ...
          manualResultReason: hasOverride ? Value(_reason.text.trim()) : const Value(null),
          manualResultChangedAt: hasOverride ? Value(DateTime.now()) : const Value(null),
          manualResultInstructorInitials: hasOverride && _initials.text.trim().isNotEmpty ? Value(_initials.text.trim()) : const Value(null),
